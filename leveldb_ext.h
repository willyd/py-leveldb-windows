...
// Define library export symbols for windows
#if (defined WIN32 || defined _WIN32 || defined WINCE) && defined LEVELDB_DLL
#define LEVELDB_EXPORT __declspec(dllimport)
#elif (defined WIN32 || defined _WIN32 || defined WINCE) && defined DLL_BUILD
...
extern "C" void LEVELDB_EXPORT initleveldb(void);
